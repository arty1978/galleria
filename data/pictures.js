class Picture {
  //class must be started from capital letter
...
const pictures = [
  new Picture("0061665_-.jpeg", "Sheep", "Menashe Kadishman", 20000, false),
  ...
  new Picture(
    "Pablo-Picasso-Buste-De-Femme-Assise3.webp",
    "Buste de femme assise",
    "Pablo Picasso",
    35000,
    true
  ),
